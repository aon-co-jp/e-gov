...
pub fn common(lang: Lang) -> CommonStrings {
    ...
    match lang {
        Lang::En => CommonStrings {
            ...
            nav_realestate: "Real Estate", nav_research: "Auto Research", nav_board: "Negotiation & TV Chat", banner_en: BANNER_EN, banner_local: BANNER_EN,
        ...
        Lang::Ja => CommonStrings {
            ...
            nav_realestate: "不動産・AI工務店", nav_research: "自動調査・マーケティング", nav_board: "商談・TV CHAT",
            banner_en: BANNER_EN,
        ...
        Lang::ZhCn => CommonStrings {
            ...
            nav_realestate: "不动产", nav_research: "自动调查", nav_board: "商务洽谈・视频聊天",
            banner_en: BANNER_EN,
        ...
        Lang::ZhTw => CommonStrings {
            ...
            nav_realestate: "不動產", nav_research: "自動調查", nav_board: "商務洽談・視訊聊天",
            banner_en: BANNER_EN,
        ...
        Lang::Ko => CommonStrings {
            ...
            nav_realestate: "부동산", nav_research: "자동 조사", nav_board: "상담・화상채팅",
            banner_en: BANNER_EN,
        ...
        Lang::It => CommonStrings {
            ...
            nav_realestate: "Immobiliare", nav_research: "Ricerca automatica", nav_board: "Trattative & TV Chat",
            banner_en: BANNER_EN,
        ...
        Lang::Fr => CommonStrings {
            ...
            nav_realestate: "Immobilier", nav_research: "Recherche auto", nav_board: "Négociation & TV Chat",
            banner_en: BANNER_EN,
        ...
        Lang::De => CommonStrings {
            ...
            nav_realestate: "Immobilien", nav_research: "Auto-Recherche", nav_board: "Verhandlung & TV Chat",
            banner_en: BANNER_EN,
        ...
        Lang::Ar => CommonStrings {
            ...
            nav_realestate: "العقارات", nav_research: "بحث آلي", nav_board: "التفاوض ومحادثة الفيديو",
            banner_en: BANNER_EN,
        ...
        Lang::Fa => CommonStrings {
            ...
            nav_realestate: "املاک", nav_research: "پژوهش خودکار", nav_board: "مذاکره و گفتگوی تصویری",
            banner_en: BANNER_EN,
        ...
        Lang::Ru => CommonStrings {
            ...
            nav_realestate: "Недвижимость", nav_research: "Авто-исследование", nav_board: "Переговоры и видеочат",
            banner_en: BANNER_EN,
        ...
        Lang::Uk => CommonStrings {
            ...
            nav_realestate: "Нерухомість", nav_research: "Авто-дослідження", nav_board: "Переговори та відеочат",
            banner_en: BANNER_EN,
...
pub fn board_text(lang: Lang) -> PageText {
    match lang {
        Lang::En | Lang::EnGb => PageText {
            title: "Negotiation & Video Chat — e-gov.info",
            h1: "WEB Negotiation & Google Meet Video Chat Corner",
            body: "A public board for arranging online business negotiations and casual video-chat meetups with people worldwide via Google Meet. Post a message (and an optional Google Meet link) below.",
        },
        Lang::Ja => PageText {
            title: "商談・TV CHAT — e-gov.info",
            h1: "WEB商談・Google Meet TV CHATコーナー",
            body: "オンラインでの商談や、世界中の人とのGoogle Meetによる気軽なビデオチャットの待ち合わせ場所です。下のフォームからメッセージ(任意でGoogle MeetのURL)を投稿できます。",
        },
        Lang::ZhCn => PageText {
            title: "商务洽谈・视频聊天 — e-gov.info",
            h1: "WEB商务洽谈・Google Meet 视频聊天角",
            body: "用于安排在线商务洽谈，以及通过Google Meet与世界各地的人进行随意视频聊天的公共留言板。可在下方表单发布留言(可选填Google Meet链接)。",
        },
        Lang::ZhTw => PageText {
            title: "商務洽談・視訊聊天 — e-gov.info",
            h1: "WEB商務洽談・Google Meet 視訊聊天角",
            body: "用於安排線上商務洽談，以及透過Google Meet與世界各地的人進行輕鬆視訊聊天的公開留言板。可在下方表單發佈留言(可選填Google Meet連結)。",
        },
        Lang::Ko => PageText {
            title: "상담・화상채팅 — e-gov.info",
            h1: "WEB 상담・Google Meet 화상채팅 코너",
            body: "온라인 상담이나 Google Meet를 통한 전 세계 사람들과의 편안한 화상채팅을 위한 공개 게시판입니다. 아래 양식으로 메시지(선택적으로 Google Meet 링크)를 게시할 수 있습니다.",
        },
        Lang::It => PageText {
            title: "Trattative & Videochat — e-gov.info",
            h1: "Angolo per Trattative WEB & Videochat Google Meet",
            body: "Una bacheca pubblica per organizzare trattative commerciali online e videochat informali con persone di tutto il mondo tramite Google Meet. Pubblica un messaggio (con un link Google Meet opzionale) qui sotto.",
        },
        Lang::Fr => PageText {
            title: "Négociation & Visioconférence — e-gov.info",
            h1: "Coin Négociation WEB & Visioconférence Google Meet",
            body: "Un tableau public pour organiser des négociations commerciales en ligne et des visioconférences décontractées avec des personnes du monde entier via Google Meet. Publiez un message (avec un lien Google Meet optionnel) ci-dessous.",
        },
        Lang::De => PageText {
            title: "Verhandlung & Videochat — e-gov.info",
            h1: "WEB-Verhandlungs- & Google-Meet-Videochat-Ecke",
            body: "Eine öffentliche Pinnwand zur Vereinbarung von Online-Geschäftsverhandlungen und zwanglosen Videochats mit Menschen weltweit über Google Meet. Poste unten eine Nachricht (mit optionalem Google-Meet-Link).",
        },
        Lang::Ar => PageText {
            title: "التفاوض ومحادثة الفيديو — e-gov.info",
            h1: "ركن التفاوض عبر الويب ومحادثة فيديو Google Meet",
            body: "لوحة عامة لترتيب مفاوضات الأعمال عبر الإنترنت ومحادثات الفيديو غير الرسمية مع أشخاص من جميع أنحاء العالم عبر Google Meet. انشر رسالة (مع رابط Google Meet اختياري) أدناه.",
        },
        Lang::Fa => PageText {
            title: "مذاکره و گفتگوی تصویری — e-gov.info",
            h1: "گوشهٔ مذاکرهٔ وب و گفتگوی تصویری Google Meet",
            body: "تابلوی عمومی برای هماهنگی مذاکرات تجاری آنلاین و گفتگوی تصویری غیررسمی با افراد سراسر جهان از طریق Google Meet. پیامی (همراه با لینک اختیاری Google Meet) در زیر ارسال کنید.",
        },
        Lang::Ru => PageText {
            title: "Переговоры и видеочат — e-gov.info",
            h1: "Уголок веб-переговоров и видеочата Google Meet",
            body: "Публичная доска для организации онлайн-переговоров и непринуждённого видеочата с людьми со всего мира через Google Meet. Оставьте сообщение (и, при желании, ссылку Google Meet) ниже.",
        },
        Lang::Uk => PageText {
            title: "Переговори та відеочат — e-gov.info",
            h1: "Куточок веб-переговорів і відеочату Google Meet",
            body: "Публічна дошка для організації онлайн-переговорів і невимушеного відеочату з людьми з усього світу через Google Meet. Залиште повідомлення (і, за бажанням, посилання Google Meet) нижче.",
        },
    }
}

/// 掲示板ページのUIラベル(フォームのフィールド名・ボタン等)。
pub struct BoardStrings {
    pub negotiation_heading: &'static str,
    pub tvchat_heading: &'static str,
...
pub fn board_strings(lang: Lang) -> BoardStrings {
    match lang {
        Lang::En | Lang::EnGb => BoardStrings {
            negotiation_heading: "WEB Negotiation",
            tvchat_heading: "Google Meet TV Chat",
            name_label: "Name",
            message_label: "Message",
            link_label: "Google Meet link (optional)",
            submit_label: "Post",
            no_posts: "No posts yet.",
        },
        Lang::Ja => BoardStrings {
            negotiation_heading: "WEB商談",
            tvchat_heading: "Google Meet TV CHAT",
            name_label: "お名前",
            message_label: "メッセージ",
            link_label: "Google MeetのURL(任意)",
            submit_label: "投稿する",
            no_posts: "まだ投稿がありません。",
        },
        Lang::ZhCn => BoardStrings {
            negotiation_heading: "WEB商务洽谈",
            tvchat_heading: "Google Meet 视频聊天",
            name_label: "姓名",
            message_label: "留言内容",
            link_label: "Google Meet链接(可选)",
            submit_label: "发布",
            no_posts: "暂无留言。",
        },
        Lang::ZhTw => BoardStrings {
            negotiation_heading: "WEB商務洽談",
            tvchat_heading: "Google Meet 視訊聊天",
            name_label: "姓名",
            message_label: "留言內容",
            link_label: "Google Meet連結(可選)",
            submit_label: "發佈",
            no_posts: "尚無留言。",
        },
        Lang::Ko => BoardStrings {
            negotiation_heading: "WEB 상담",
            tvchat_heading: "Google Meet 화상채팅",
            name_label: "이름",
            message_label: "메시지",
            link_label: "Google Meet 링크(선택)",
            submit_label: "게시하기",
            no_posts: "아직 게시물이 없습니다.",
        },
        Lang::It => BoardStrings {
            negotiation_heading: "Trattativa WEB",
            tvchat_heading: "Videochat Google Meet",
            name_label: "Nome",
            message_label: "Messaggio",
            link_label: "Link Google Meet (opzionale)",
            submit_label: "Pubblica",
            no_posts: "Nessun messaggio ancora.",
        },
        Lang::Fr => BoardStrings {
            negotiation_heading: "Négociation WEB",
            tvchat_heading: "Visioconférence Google Meet",
            name_label: "Nom",
            message_label: "Message",
            link_label: "Lien Google Meet (facultatif)",
            submit_label: "Publier",
            no_posts: "Aucun message pour le moment.",
        },
        Lang::De => BoardStrings {
            negotiation_heading: "WEB-Verhandlung",
            tvchat_heading: "Google-Meet-Videochat",
            name_label: "Name",
            message_label: "Nachricht",
            link_label: "Google-Meet-Link (optional)",
            submit_label: "Veröffentlichen",
            no_posts: "Noch keine Beiträge.",
        },
        Lang::Ar => BoardStrings {
            negotiation_heading: "تفاوض عبر الويب",
            tvchat_heading: "محادثة فيديو Google Meet",
            name_label: "الاسم",
            message_label: "الرسالة",
            link_label: "رابط Google Meet (اختياري)",
            submit_label: "نشر",
            no_posts: "لا توجد منشورات بعد.",
        },
        Lang::Fa => BoardStrings {
            negotiation_heading: "مذاکرهٔ وب",
            tvchat_heading: "گفتگوی تصویری Google Meet",
            name_label: "نام",
            message_label: "پیام",
            link_label: "لینک Google Meet (اختیاری)",
            submit_label: "ارسال",
            no_posts: "هنوز پستی وجود ندارد.",
        },
        Lang::Ru => BoardStrings {
            negotiation_heading: "Веб-переговоры",
            tvchat_heading: "Видеочат Google Meet",
            name_label: "Имя",
            message_label: "Сообщение",
            link_label: "Ссылка Google Meet (необязательно)",
            submit_label: "Опубликовать",
            no_posts: "Пока нет сообщений.",
        },
        Lang::Uk => BoardStrings {
            negotiation_heading: "Веб-переговори",
            tvchat_heading: "Відеочат Google Meet",
            name_label: "Ім'я",
            message_label: "Повідомлення",
            link_label: "Посилання Google Meet (необов'язково)",
            submit_label: "Опублікувати",
            no_posts: "Поки що немає повідомлень.",
        },
    }
}
